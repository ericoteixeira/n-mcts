...
import pickle
with open('../H_acai_4_new.pkl', 'rb') as fp:
    _PCA_HAM = pickle.load(fp)
...
class FourQubitH2_VaccumInitial(ModelFromK):

    name = "FourQubitH2_VaccumInitial"
...
class FourActiveSpacePCA(ModelFromK):

    name = "FourActiveSpacePCA"
